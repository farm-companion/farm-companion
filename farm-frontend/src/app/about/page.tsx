...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-background-canvas">
      ...
      <section className="mb-16">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-display font-bold text-text-heading font-heading">
              What we do
            </h2>
      ...
      <section className="mb-16">
        <h2 className="text-display font-bold text-text-heading font-heading text-center mb-12">
          How we&apos;re different
        </h2>
      ...
      <section className="mb-16 bg-background-surface rounded-2xl p-8 border border-border-default relative overflow-hidden">
        ...
        <div className="text-center mb-8 relative z-10">
          ...
          <h2 className="text-display font-bold text-text-heading font-heading mb-4">
            Trust & verification
          </h2>
      ...
      <section className="mb-16">
        <div className="bg-gradient-to-br from-midnight/5 to-obsidian/5 rounded-2xl p-8 border border-border-default">
          <h2 className="text-display font-bold text-text-heading font-heading text-center mb-6">
            Privacy & ads
          </h2>
      ...
      <section className="mb-16">
        <h2 className="text-display font-bold text-text-heading font-heading text-center mb-8">
