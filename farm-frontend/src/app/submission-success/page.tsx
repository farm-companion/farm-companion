    ...
    <main className="min-h-screen bg-background-canvas">
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-display font-bold text-text-heading font-heading mb-4">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-12">
                ...
                <div className="space-y-3">
                  {contactEmail && (
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-body text-text-heading">{contactEmail}</span>
                    </div>
                  )}
                  {contactPhone && (
                    <div className="flex items-center space-x-3">
                      <Phone className="w-4 h-4 text-text-muted" />
                      <span className="text-body text-text-heading">{contactPhone}</span>
                    </div>
                  )}
                </div>
              </div>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-8 space-y-6">
              {/* Next Steps */}
              <div className="bg-background-surface rounded-xl p-6 border border-border-default">
                <h3 className="text-heading font-semibold text-text-heading mb-4 flex items-center space-x-2">
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="text-body font-medium text-text-heading">Review Process</p>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="text-body font-medium text-text-heading">Quality Check</p>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="text-body font-medium text-text-heading">Go Live</p>
              ...
              {/* Actions */}
              <div className="bg-background-surface rounded-xl p-6 border border-border-default">
                <h3 className="text-heading font-semibold text-text-heading mb-4">Quick Actions</h3>
              ...
              {/* Status Tracking */}
              <div className="bg-background-surface rounded-xl p-6 border border-border-default">
                <h3 className="text-heading font-semibold text-text-heading mb-4">Track Your Submission</h3>
                
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-body text-text-heading">Status</span>
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-body text-text-heading">Submitted</span>
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-body text-text-heading">Expected Review</span>
                    <span className="text-body text-text-muted">
