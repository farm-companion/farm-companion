...
// All fonts loaded via CSS in fonts.css with system font fallbacks
// Primary: Clash Display (self-hosted)
// Body: Manrope (loaded via Google Fonts link in head)
// Accent: IBM Plex Sans Condensed (loaded via Google Fonts link in head)
