  ...
  return (
    <article className="bg-white dark:bg-obsidian rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow duration-200">
      ...
      <div className="p-6">
        ...
        <div className="mb-4">
          <h3 className="text-heading font-semibold text-obsidian dark:text-sandstone mb-2">
            {farm.name}
          </h3>
        ...
        <div className="flex items-center justify-between pt-4 border-t border-gray-200 dark:border-gray-700">
          <Link
            href={`/shop/${farm.slug}`}
            className="text-serum hover:text-serum/80 font-medium text-body flex items-center gap-1"
          >
            View Details
          ...
          <Link
            ...
            className="bg-serum text-black px-4 py-2 rounded-lg font-semibold text-body hover:bg-serum/90 transition-colors duration-200"
          >
            Claim This Shop
          </Link>
        </div>
  ...
  return (
    <div className="border-b border-sandstone/20 dark:border-gray-700 pb-12 last:border-b-0">
      <div className="flex items-center justify-between mb-8">
        ...
        <span className="text-body font-semibold text-serum bg-serum/10 dark:bg-serum/20 px-4 py-2 rounded-full border border-serum/20 dark:border-serum/30">
      ...
      <main className="min-h-screen bg-background-canvas dark:bg-gray-900">
        ...
        <div className="relative h-full flex items-center justify-center pt-20 pb-20">
          <div className="text-center max-w-4xl mx-auto px-6">
            ...
            <h1 className="text-display font-heading font-bold mb-6 text-white drop-shadow-lg">
              Claim Your Farm
              <span className="block text-serum drop-shadow-lg">Shop Listing</span>
            </h1>
            <p className="text-heading text-white/90 mb-4 drop-shadow-md max-w-3xl mx-auto">
              Take control of your farm shop&apos;s online presence. Update information, add photos, and connect with customers.
            </p>
            <p className="text-body text-white/80 mb-8 drop-shadow-md max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-2xl mx-auto mb-8">
              <div className="text-center">
                <div className="text-display font-heading font-bold text-serum mb-2 drop-shadow-lg">{stats.farmCount}+</div>
                <div className="text-white/80 text-body">Active Listings</div>
              </div>
              <div className="text-center">
                <div className="text-display font-heading font-bold text-serum mb-2 drop-shadow-lg">{stats.countyCount}</div>
                <div className="text-white/80 text-body">UK Counties</div>
              </div>
              <div className="text-center">
                <div className="text-display font-heading font-bold text-serum mb-2 drop-shadow-lg">100%</div>
                <div className="text-white/80 text-body">Free to Claim</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-background-surface dark:bg-gray-800">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-display font-heading font-bold text-text-heading dark:text-white mb-4">
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-border-default/30 shadow-sm p-8 mb-12">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-heading font-heading font-semibold text-text-heading dark:text-white">
          ...
          <div className="mt-16 bg-gradient-to-r from-serum/10 to-solar/10 rounded-2xl border border-serum/20 p-8 text-center">
            ...
            <h2 className="text-heading font-heading font-semibold text-text-heading dark:text-white mb-4">
