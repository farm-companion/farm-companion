...
export async function POST() {
  const logger = createRouteLogger('admin/photos/cleanup-deleted')
  ...
  try {
    ...
    // Get all approved photo IDs from all farms using pipeline
    ...
    // Find deleted photos
    const deletedPhotos = blobCheckResults
    ...
    logger.info('Found deleted photos', {
    ...
    // Remove deleted photos using pipeline for atomic operations
    ...
    logger.info('Cleanup completed', { removed: deletedPhotos.length })
