  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-8">
      <header className="mb-8">
        <h1 className="text-display font-semibold tracking-tight">Claims Management</h1>
      ...
      {claims.length === 0 ? (
        <div className="rounded-lg border border-gray-200 bg-gray-50 p-8 text-center dark:border-gray-700 dark:bg-gray-800/50">
          <h3 className="text-heading font-medium text-gray-900 dark:text-gray-100">No claims yet</h3>
      ...
      <div className="flex items-start justify-between">
        <div className="flex-1">
          <div className="flex items-center space-x-3">
            <h3 className="text-heading font-medium text-gray-900 dark:text-gray-100">
              {claim.shopName}
            </h3>
        ...
        <div className="ml-6 flex flex-col space-y-2">
          <Link
            href={claim.shopUrl}
            className="rounded border border-gray-300 px-3 py-1 text-body text-gray-700 hover:bg-gray-50 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-700"
          >
            View Shop
          </Link>
          ...
          {claim.status === 'pending' && (
            <div className="flex space-x-2">
              <button className="rounded bg-green-600 px-3 py-1 text-body text-white hover:bg-green-700">
                Approve
              </button>
              <button className="rounded bg-red-600 px-3 py-1 text-body text-white hover:bg-red-700">
                Reject
              </button>
            </div>
          )}
