...
export default function FarmReviewInterface() {
  ...
  const getStatusBadge = (status: string) => {
    const baseClasses = "px-2 py-1 text-captionall rounded-full font-medium"
    switch (status) {
      case 'pending':
    ...
    <div className="space-y-6">
        ...
        <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <p className="text-display font-bold text-gray-900 dark:text-white">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
          <h3 className="text-heading font-medium text-gray-900 dark:text-white">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-4 mt-1">
                        ...
                        <span className="text-captionall text-gray-400">
                          Submitted {new Date(submission.submittedAt).toLocaleDateString()}
                        </span>
                        {submission.images.length > 0 && (
                          <span className="text-captionall text-gray-400 flex items-center">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-6">
              {/* Farm Details */}
              <div>
                <h3 className="text-heading font-medium text-gray-900 dark:text-white mb-4">Farm Details</h3>
              ...
              {/* Contact Information */}
              <div>
                <h3 className="text-heading font-medium text-gray-900 dark:text-white mb-4">Contact Information</h3>
              ...
              {selectedSubmission.offerings.length > 0 && (
                <div>
                  <h3 className="text-heading font-medium text-gray-900 dark:text-white mb-4">Offerings</h3>
                  <div className="flex flex-wrap gap-2">
                    {selectedSubmission.offerings.map((offering, index) => (
                      <span 
                        key={index}
                        className="px-2 py-1 bg-serum/10 text-serum text-captionall rounded-full"
                      >
                        {offering}
                      </span>
                    ))}
              ...
              {selectedSubmission.story && (
                <div>
                  <h3 className="text-heading font-medium text-gray-900 dark:text-white mb-4">Farm Story</h3>
              ...
              {selectedSubmission.images.length > 0 && (
                <div>
                  <h3 className="text-heading font-medium text-gray-900 dark:text-white mb-4">
                      ...
                      <div key={image.id} className="aspect-square bg-gray-100 dark:bg-gray-700 rounded-lg flex items-center justify-center">
                        {image.url ? (
                          ...
                          <div className="text-center">
                            ...
                            <p className="text-captionall text-gray-500">{image.name}</p>
                          </div>
                        )}
                      </div>
                    ))}
              ...
              {selectedSubmission.status === 'pending' && (
                <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
                  <h3 className="text-heading font-medium text-gray-900 dark:text-white mb-4">Review Actions</h3>
                  <div className="flex flex-col sm:flex-row gap-4">
                    <Button
              ...
              {selectedSubmission.status === 'approved' && (
                <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
                  <h3 className="text-heading font-medium text-gray-900 dark:text-white mb-4">Live Directory</h3>
                  <div className="flex flex-col sm:flex-row gap-4">
                    <Button
