      ...
      {images.length > 0 && (
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="text-heading font-semibold text-text-heading">
            ...
            {images.map((image) => (
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-3">
                  <p className="text-white text-captionall font-medium truncate">
                    {image.file.name}
                  </p>
                  <p className="text-white/80 text-captionall">
                ...
                {/* Error Message */}
                {image.error && (
                  <div className="absolute bottom-0 left-0 right-0 bg-red-600 text-white text-captionall p-2">
                    {image.error}
                  </div>
                )}
              </div>
