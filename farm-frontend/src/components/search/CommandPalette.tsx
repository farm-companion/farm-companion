      ...
      <div className="absolute inset-x-4 top-[15vh] mx-auto max-w-xl">
        ...
        >
          ...
          <div className="flex items-center gap-3 px-4 border-b border-slate-200 dark:border-white/[0.06]">
            <Search className="w-5 h-5 text-slate-600 dark:text-slate-300 flex-shrink-0" />
            <input
              ref={inputRef}
              type="text"
              value={query}
            ...
            <button
              onClick={close}
              className="p-1.5 rounded-md hover:bg-slate-100 dark:hover:bg-white/[0.04] text-slate-600 dark:text-slate-300"
              aria-label="Close"
            >
              <X className="w-5 h-5" />
            </button>
                    ...
                    <li key={result.id} role="option" aria-selected={isSelected}>
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {result.subtitle && (
                            <p className="text-caption text-slate-600 dark:text-slate-300 truncate">
                              {result.subtitle}
                            </p>
                          )}
                        </div>
          ...
          <div className="flex items-center justify-between px-4 py-2.5 border-t border-slate-200 dark:border-white/[0.06] bg-slate-50/50 dark:bg-white/[0.02]">
            <div className="flex items-center gap-4 text-caption text-slate-600 dark:text-slate-300">
