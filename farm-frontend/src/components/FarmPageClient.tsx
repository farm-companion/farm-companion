      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-background-surface via-background-canvas to-background-surface">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-16">
          ...
          >
            ...
            <motion.h1
              variants={fadeInUp}
              className="text-display md:text-6xl lg:text-7xl font-heading font-bold text-text-heading mb-8 tracking-tight leading-tight"
            >
            ...
            >
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                className="group bg-gradient-to-r from-serum to-teal-500 text-black px-10 py-5 rounded-2xl font-bold text-heading hover:from-teal-500 hover:to-serum transition-all duration-300 inline-flex items-center justify-center gap-3 shadow-2xl hover:shadow-3xl"
              >
      ...
      {shop.images && Array.isArray(shop.images) && shop.images.length > 0 && shop.images.some(img => img && typeof img === 'string' && img.trim() !== '' && !img.includes('maps.googleapis.com/maps/api/place/photo')) && (
        <section className="py-16 bg-gradient-to-b from-background-surface to-background-canvas">
          <div className="max-w-7xl mx-auto px-6">
            ...
            >
              <h2 className="text-display font-heading font-bold text-text-heading mb-4 flex items-center justify-center gap-3">
                <Camera className="w-8 h-8 text-serum" />
                Gallery
              </h2>
              <p className="text-text-muted text-heading">Discover the beauty of {name}</p>
            </motion.div>
            <motion.div
              initial="initial"
              whileInView="animate"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
          ...
          <div className="lg:col-span-2 space-y-16">
            ...
            {cleanDescription && (
              ...
              >
                <h2 className="text-display font-heading font-bold text-text-heading mb-8 flex items-center gap-3">
              ...
              <details className="group">
                <summary className="cursor-pointer list-none">
                  <div className="flex items-center justify-between">
                    <h2 className="text-display font-heading font-bold text-text-heading flex items-center gap-3">
                      <Camera className="w-8 h-8 text-serum" />
                      Add Photos
                    </h2>
                    <div className="flex items-center gap-3">
                      <span className="text-heading text-text-muted group-open:hidden">Share your experience</span>
                ...
                <div className="mt-10 pt-8 border-t border-border-default/50">
                  <p className="text-text-muted text-heading mb-8">
