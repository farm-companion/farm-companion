      ...
      <div className="flex gap-3 p-4">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-2 flex flex-wrap gap-1.5">
            {isVerified && (
              <span className="inline-flex items-center gap-1 px-2 py-0.5 text-captionall rounded-full bg-green-100 text-green-700">
            ...
            {hasPhotos && (
              <span className="inline-flex items-center gap-1 px-2 py-0.5 text-captionall rounded-full bg-blue-100 text-blue-700">
