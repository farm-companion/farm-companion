    ...
    return (
      <div className={`text-center py-8 ${className}`}>
        <div className="text-gray-500">
          ...
          <p className="text-heading font-medium">No photos yet</p>
        ...
        {photos.map((photo) => (
          ...
          >
            ...
            <div className="aspect-square relative overflow-hidden bg-gray-100">
              ...
              {/* Status badge */}
              {showStatus && (
                <div className={`absolute top-2 right-2 px-2 py-1 rounded-full text-captionall font-medium border ${getStatusColor(photo.status)}`}>
              ...
              {/* Quality score */}
              {photo.qualityScore && (
                <div className="absolute top-2 left-2 px-2 py-1 rounded-full text-captionall font-medium bg-black bg-opacity-50 text-white">
