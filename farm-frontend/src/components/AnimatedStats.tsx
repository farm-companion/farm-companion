        ...
        >
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className={`text-display font-heading font-bold ${stat.colorText} mb-1 sm:mb-2`}>
                {stat.value}
              </div>
              <div className="text-body font-semibold text-text-heading mb-1">{stat.label}</div>
              <div className="text-caption text-text-muted px-2">{stat.description}</div>
            </motion.div>
          ))}
        </motion.div>
      </div>
