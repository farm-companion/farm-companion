  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="rounded-lg border bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800/50">
        <h3 className="text-heading font-medium text-gray-900 dark:text-gray-100">Shop Information</h3>
      ...
      <div className="space-y-4">
        <h3 className="text-heading font-medium text-gray-900 dark:text-gray-100">Your Details</h3>
      ...
      {/* Claim Type */}
      <div className="space-y-4">
        <h3 className="text-heading font-medium text-gray-900 dark:text-gray-100">Claim Type</h3>
      ...
      {/* Verification Method */}
      <div className="space-y-4">
        <h3 className="text-heading font-medium text-gray-900 dark:text-gray-100">Verification</h3>
