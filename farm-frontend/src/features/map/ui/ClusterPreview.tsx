...
import { MapPin, ZoomIn, List, Navigation, Leaf } from 'lucide-react'
          ...
          <div className="mb-4">
            ...
            <div className="space-y-2 max-h-32 overflow-y-auto">
              {farms.slice(0, 5).map((farm, index) => {
                const isInSeason = searchQuery && farm.offerings?.some(o => o.toLowerCase().includes(searchQuery.toLowerCase()))
                return (
                  <div key={farm.id || index} className="flex items-center justify-between p-2 bg-gray-50 rounded-lg">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        ...
                        {isInSeason && (
                          <div className="inline-flex items-center gap-1 px-1.5 py-0.5 bg-emerald-100 text-emerald-700 rounded text-xs font-medium flex-shrink-0">
