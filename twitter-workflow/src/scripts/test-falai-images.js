...
/**
 * Test script for fal.ai/qwen-image integration
...
async function testFalAIImages() {
  console.log('🧪 Testing fal.ai/qwen-image integration...\n');
  ...
  try {
    ...
    if (imageBuffer) {
      ...
      console.log(`🎯 Provider: fal.ai/qwen-image`);
      ...
      console.log('🔍 Check your FAL_AI_API_KEY environment variable');
    }
  } catch (error) {
